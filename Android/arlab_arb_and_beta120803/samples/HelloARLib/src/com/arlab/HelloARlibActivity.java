...
public class HelloARlibActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	if(isTablet())
        	aRbrowserView = new ARbrowserView(this,ARbrowserView.UI_ORIENTATION_ALL,"8qa6/UnHTrE+Fp6j0swSs8cwDR1SlxnP8PT+zq09SA==", ARbrowserView.SCREEN_ORIENTATION_LANDSCAPE,true,true);
        else
        	aRbrowserView = new ARbrowserView(this,ARbrowserView.UI_ORIENTATION_ALL,"8qa6/UnHTrE+Fp6j0swSs8cwDR1SlxnP8PT+zq09SA==", ARbrowserView.SCREEN_ORIENTATION_PORTRAIT,false,true);
