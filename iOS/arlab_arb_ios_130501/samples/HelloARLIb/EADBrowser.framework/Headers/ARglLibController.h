 ...
 */
-(void) poiClicked:(Poi*)poi ARLAB_AVAILABLE(ARB_120401);
 ...
 */
-(void) poiSelected:(Poi*)poi ARLAB_AVAILABLE(ARB_120401);
 ...
 */
-(id) initWithAppKey:(NSString*) appKey ARLAB_AVAILABLE(ARB_120401);
...
/**
 ...
 @return instance of newly initialized ARglLibController
 */
-(id) initWithAppKey:(NSString*) appKey useDefaultCamera:(BOOL)useDefaultCamera ARLAB_AVAILABLE(ARB_120401);
 ...
 */
-(int) add:(Poi*) poi ARLAB_AVAILABLE(ARB_120401);
 ...
 */
-(BOOL) add:(Poi*)poi withId:(int)uId ARLAB_AVAILABLE(ARB_120401);
 ...
 */
-(Poi*) getPoi:(int)uId ARLAB_AVAILABLE(ARB_120504);
 ...
 */
-(BOOL) remove:(Poi*) poi ARLAB_AVAILABLE(ARB_120401);
/**
 @brief Removes POI from the AR Browser
 @param uId id of the poi to be removed
 @return True is poi found and removed
 */
-(BOOL) removePoiWithId:(int)uId ARLAB_AVAILABLE(ARB_120401);

/**
 @brief Removes all POI from the AR Browser
 */
-(void) removeAllPois ARLAB_AVAILABLE(ARB_120401);

/**
 @brief Starts running the AR Browser
 */
-(void) start ARLAB_AVAILABLE(ARB_120401);

/**
 @brief Stops the AR Browser
 */
-(void) stop ARLAB_AVAILABLE(ARB_120401);

/**
 @brief Sets the POI size
 @param size can be any of: poi_size_small, poi_size_normal, poi_size_big
 */
-(void) setPoiSize:(poi_size)size ARLAB_AVAILABLE(ARB_120501);
 ...
 */
-(void) setPopupMode:(popup_mode)mode ARLAB_AVAILABLE(ARB_120401);
 ...
 */
-(void) setUIorientationMode:(orientations_mode)mode ARLAB_AVAILABLE(ARB_120401);

/**
 @brief Sets the radar offset from the top left corner
 @param size in pixels
 */
-(void) setRadarOffset:(int)offset ARLAB_AVAILABLE(ARB_120501);;

/**
 @brief Status of AR Browser
 @return true if running, false otherwize
 */
-(BOOL) isRunning ARLAB_AVAILABLE(ARB_120504);;
 ...
 */
-(void) updateLocation:(CLLocation *)newuserLocation ARLAB_AVAILABLE(ARB_120401); 
