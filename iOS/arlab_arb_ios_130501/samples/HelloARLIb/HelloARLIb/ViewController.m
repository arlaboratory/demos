...
- (void)viewDidLoad
{
    ...
    _arlibCtrl = [[ARglLibController alloc] initWithAppKey:@"kxwm4fGRe2PIJD5DJcY2a6gcJjuezSpmKQMW00+PLA=="];
    
    [_arlibCtrl.view setFrame:self.view.frame];
    
    [_arlibCtrl setRadarOffset:10];
    ...
    [thirdPoi setIconFromUrl:[NSURL URLWithString:@"http://thecustomizewindows.com/wp-content/uploads/2011/11/Best-Android-Apps-List-of-50-Free-Android-Apps.png"]];
